...
def print_scores_new(scores):
    print("------------------------------------------------------------------------------")
    if "trigger_id" in scores:
        print('Tri-I            - P: {:6.2f} ({:5d}/{:5d}), R: {:6.2f} ({:5d}/{:5d}), F: {:6.2f}'.format(
            scores["trigger_id"]["precision"], scores["trigger_id"]["p_match_num"], scores["trigger_id"]["pred_num"], 
            scores["trigger_id"]["recall"], scores["trigger_id"]["r_match_num"], scores["trigger_id"]["gold_num"], scores["trigger_id"]["f1"]))
    if "trigger_cls" in scores:
        print('Tri-C            - P: {:6.2f} ({:5d}/{:5d}), R: {:6.2f} ({:5d}/{:5d}), F: {:6.2f}'.format(
            scores["trigger_cls"]["precision"], scores["trigger_cls"]["p_match_num"], scores["trigger_cls"]["pred_num"], 
            scores["trigger_cls"]["recall"], scores["trigger_cls"]["r_match_num"], scores["trigger_cls"]["gold_num"], scores["trigger_cls"]["f1"]))
    if "argument_id" in scores:
        print('Arg-I            - P: {:6.2f} ({:5d}/{:5d}), R: {:6.2f} ({:5d}/{:5d}), F: {:6.2f}'.format(
            scores["argument_id"]["precision"], scores["argument_id"]["p_match_num"], scores["argument_id"]["pred_num"], 
            scores["argument_id"]["recall"], scores["argument_id"]["r_match_num"], scores["argument_id"]["gold_num"], scores["argument_id"]["f1"]))
    if "argument_cls" in scores:
        print('Arg-C            - P: {:6.2f} ({:5d}/{:5d}), R: {:6.2f} ({:5d}/{:5d}), F: {:6.2f}'.format(
            scores["argument_cls"]["precision"], scores["argument_cls"]["p_match_num"], scores["argument_cls"]["pred_num"], 
            scores["argument_cls"]["recall"], scores["argument_cls"]["r_match_num"], scores["argument_cls"]["gold_num"], scores["argument_cls"]["f1"]))
    if "argument_attached_id" in scores:
        print('Arg-I (attached) - P: {:6.2f} ({:5d}/{:5d}), R: {:6.2f} ({:5d}/{:5d}), F: {:6.2f}'.format(
            scores["argument_attached_id"]["precision"], scores["argument_attached_id"]["p_match_num"], scores["argument_attached_id"]["pred_num"], 
            scores["argument_attached_id"]["recall"], scores["argument_attached_id"]["r_match_num"], scores["argument_attached_id"]["gold_num"], scores["argument_attached_id"]["f1"]))
    if "argument_attached_cls" in scores:
        print('Arg-C (attached) - P: {:6.2f} ({:5d}/{:5d}), R: {:6.2f} ({:5d}/{:5d}), F: {:6.2f}'.format(
            scores["argument_attached_cls"]["precision"], scores["argument_attached_cls"]["p_match_num"], scores["argument_attached_cls"]["pred_num"], 
            scores["argument_attached_cls"]["recall"], scores["argument_attached_cls"]["r_match_num"], scores["argument_attached_cls"]["gold_num"], scores["argument_attached_cls"]["f1"]))
    print("------------------------------------------------------------------------------")
